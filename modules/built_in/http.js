...
// ?  get() ----> It is used to fetch resoure from the server.
...
let server = http.createServer((req, res)=> {
    ...
    // res.write("this is after cycle ended"); // this will throw an error
});
...
// ! to tap into  the server, open browser and type localhost 
